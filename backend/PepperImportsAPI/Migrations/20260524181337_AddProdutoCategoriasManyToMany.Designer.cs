...
namespace PepperImportsAPI.Migrations
{
    ...
    [Migration("20260524181337_AddProdutoCategoriasManyToMany")]
    partial class AddProdutoCategoriasManyToMany
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PepperImportsAPI.Domain.Entities.ContaAPagar", b =>
                {
                    b.Property<int>("ContaAPagarId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("ContaAPagarId"));
            ...
            modelBuilder.Entity("PepperImportsAPI.Domain.Entities.Despesa", b =>
                {
                    b.Property<int>("DespesaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PepperImportsAPI.Domain.Entities.EntradaEstoque", b =>
                {
            ...
            modelBuilder.Entity("PepperImportsAPI.Domain.Entities.ProdutoEstoque", b =>
                {
                    b.Property<int>("ProdutoEstoqueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("ProdutoEstoqueId"));
            ...
            modelBuilder.Entity("CategoriaProduto", b =>
                {
                    b.HasOne("PepperImportsAPI.Domain.Entities.Categoria", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PepperImportsAPI.Domain.Entities.ContaAPagar", b =>
                {
                    b.HasOne("PepperImportsAPI.Domain.Entities.Despesa", "Despesa")
                        .WithMany()
